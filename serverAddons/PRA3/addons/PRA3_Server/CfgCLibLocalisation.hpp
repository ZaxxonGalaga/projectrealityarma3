    ...
    class PRA3 {
        ...
        class VehicleRespawn {
            class NewVehicleAvailable {
                ...
                Portuguese = "Novo veículo disponível: %1";
            };
        };
        ...
        class Squad {
            class waitToSwitchSide {
                ...
                Portuguese = "Você precisa esperar %1 segundos até poder trocar de lado novamente";
            };
            class MaxPlayerCount {
                ...
                Portuguese = "Número máximo de jogadores no lado inimigo alcançado.";
            };
        };
        ...
        class Sector {
            class YouSC {
                ...
                Portuguese = "Você capturou o setor %1";
            };
            ...
            class YourTSC {
                ...
                Portuguese = "A sua equipe capturou o setor %1";
            };
            ...
            class YouSL {
                ...
                Korean = "%1 지역을 잃었습니다.";
                Portuguese = "Você perdeu o setor %1";
            };
            class YouSN {
                ...
                Portuguese = "Você neutralizou o setor %1";
            };
            class YourTSN {
        ...
        class RespawnUI {
            class JoinASquad {
                ...
                Korean = "분대에 참여해주십시오";
                Portuguese = "Você uniu-se a um esquadão!";
            };
            class ChooseARole {
                ...
                Korean = "보직을 선택해주십시오";
                Portuguese = "Você precisa escolher uma função!"; 
            };
            class selectSpawn {
                ...
                Portuguese= "Você precisa escolher um ponto de saída!";
            };
        };
        ...
        class Logistic {
            ...
            class noCargoSpace {
                ...
                Portuguese = "Sem espaço de carga disponível";
            };
            class UnloadItem {
                ...
                Portuguese = "Descarregar item fora de %1";
            };
            class UnableToUnload {
                ...
                Portuguese = "Você está inabilitado de Descarregar a Caixa na sua posição atual.";
            };
            class itemToHeavy {
                ...
                Portuguese = "O Item é %1kg muito pesado";
            };
        };
        ...
        class Deployment {
            class SpawnsRemaining {
                ...
                Korean = "%1 (스폰 %2 남음)";
                Portuguese = "%1 (%2 Saídas disponíveis)";
            };
            // - Rally
            class CreateRally {
                ...
                Korean = "랠리포인트 생성";
                Portuguese = "Criar Ponto de Encontro"
            };
            class cantPlaceRally {
                ...
                Portuguese = "Você não pode colocar um Ponto de Encontro nesta posição";
            };
            class RallyPlaced {
                ...
                Portuguese = "O seu Líder de Esquadrão colocou um Ponto de Encontro próximo de %1";
            };
            ...
            class FOBPlaced {
                ...
                Portuguese = "Esquadrão %1 colocou um FOB próximo de %2";
            };
        ...
        class Kit {
            class NotAllowToDrive {
                ...
                Portuguese = "Não é permitido você usar este veículo.";
            };
        };
    };
};
